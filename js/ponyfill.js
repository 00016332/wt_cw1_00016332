!(function (e, t) {
                ...
                u.rules.length
                    ? r(u.absoluteUrls, {
                          ...
                          onError: function (r, s, l) {
                              c.push({ xhr: r, url: s }), i.push(u.rules[l]), e(t, n, o, a, c, i);
                          },
                    ...
                    : a(t, c);
            })((e = void 0 !== a && !1 === Boolean(a) ? "" : a || e), n, o, function (e, r) {
                null === c[t] &&
        ...
        a.length
            ? a.forEach(function (e, t) {
                  var n = e.getAttribute("href"),
                      ...
                      l = "LINK" === e.nodeName && n && a && "stylesheet" === a.toLowerCase(),
                      f = "STYLE" === e.nodeName;
                  if (l)
                      r(n, {
                          mimeType: "text/css",
    ...
    function i(e, t, r) {
        ...
        if (i >= 0 && u > 0) {
            for (n = [], s = r.length; l >= 0 && !c; )
                l == i ? (n.push(l), (i = r.indexOf(e, l + 1))) : 1 == n.length ? (c = [n.pop(), u]) : ((o = n.pop()) < s && ((s = o), (a = u)), (u = r.indexOf(t, l + 1))), (l = i < u && i >= 0 ? i : u);
            n.length && (c = [s, a]);
        }
        return c;
    }
    function u(t) {
        ...
        function A() {
            var e = i(/^@([-\w]+)?document *([^{]+)/);
            if (e) return { type: "document", document: e[2].trim(), vendor: e[1] ? e[1].trim() : null, rules: _() };
        }
        function j() {
        ...
        function _(e) {
            ...
            for (var r, n = p(); t.length && (e || "}" !== t[0]) && (r = k() || M()); ) r.type && n.push(r), (n = n.concat(p()));
                ...
                for (var r = 0; r < e.length; r++) {
                    ...
                    if ("declaration" === s)
                        if (o.preserveVars || !a || 0 !== a.indexOf("--")) {
                            if (-1 !== c.indexOf("var(")) {
                                var i = v(c, o);
                                i !== n.value && ((i = m(i)), o.preserveVars ? (e.splice(r, 0, { type: s, property: a, value: i }), r++) : (n.value = i));
                            }
                        } else e.splice(r, 1), r--;
                }
            }),
    ...
    function v(e) {
        ...
        function o(e) {
            var n = e.split(",")[0].replace(/[\s\n\t]/g, ""),
                ...
                c = r || e;
            return s || t.onWarning('variable "'.concat(n, '" is undefined')), a && "undefined" !== a && a.length > 0 ? v(a, t, c) : "var(".concat(c, ")");
        }
        if (n) {
            if ("var" === n.pre.slice(-3)) {
                var a = 0 === n.body.trim().length;
                return a ? (t.onWarning("var() must contain a non-whitespace string"), e) : n.pre.slice(0, -3) + o(n.body) + v(n.post, t);
            }
    ...
    var h = "undefined" != typeof window,
        y = h && window.CSS && window.CSS.supports && window.CSS.supports("(--a: 0)"),
        g = { group: 0, job: 0 },
        b = {
    ...
    function j() {
        ...
        if (h) {
            ...
            if ((!1 === s.watch && x && (x.disconnect(), (x = null)), !s.__benchmark)) {
                if (w === s.rootElement) return void M(r);
                if (
                    ((s.__benchmark = V()),
                    (s.exclude = [x ? '[data-cssvars]:not([data-cssvars=""])' : '[data-cssvars="out"]', s.exclude]
                        .filter(function (e) {
                            return e;
                        })
                        .join(",")),
                    ...
                    var i = Array.apply(null, s.rootElement.querySelectorAll('[data-cssvars="out"]'));
                    if (
                        ...
                        var d = s.rootElement.querySelectorAll('[data-cssvars]:not([data-cssvars="out"])');
            ...
            if ("loading" !== document.readyState)
                if (y && s.onlyLegacy) {
                    if (s.updateDOM) {
                        var m = s.rootElement.host || (s.rootElement === document ? document.documentElement : s.rootElement);
                        ...
                        : ((w = s.rootElement),
                          n({
                              ...
                              onSuccess: function (e, t, r) {
                                  ...
                                  return (e = void 0 !== n && !1 === Boolean(n) ? "" : n || e), s.updateURLs && (e = T(e, r)), e;
                              },
                                  ...
                                  if (
                                      ...
                                      o.forEach(function (e, t) {
                                          if (S.cssVars.test(n[t]))
                                              try {
                                                  ...
                                                  l(r, { parseHost: Boolean(s.rootElement.host), store: E.dom, onWarning: c }), (e.__cssVars = { tree: r });
                                              } catch (t) {
                                                  a(t.message, e);
                                              }
                                      }),
                                      e(E.job, E.dom),
                                      s.updateDOM ? (e(E.user, s.variables), e(E.job, E.user)) : (e(E.job, E.user, s.variables), e(i, s.variables)),
                                      g.job > 0 &&
                                          Boolean(
                                      ...
                                      if (
                                          ...
                                          o.forEach(function (t) {
                                              ...
                                              if (t.__cssVars)
                                                  try {
                                                      p(t.__cssVars.tree, e({}, s, { variables: E.job, onWarning: c }));
                                                      var n = f(t.__cssVars.tree);
                                                      if (s.updateDOM) {
                                                          if ((t.getAttribute("data-cssvars") || t.setAttribute("data-cssvars", "src"), n.length)) {
                                                              var o = t.getAttribute("data-cssvars-group") || ++g.group,
                                                                  i = n.replace(/\s/g, ""),
                                                              ...
                                                              (v = v || S.cssKeyframes.test(n)),
                                                                  ...
                                                                  i === t.textContent.replace(/\s/g, "")
                                                                      ? ((r = !0), u && u.parentNode && (t.removeAttribute("data-cssvars-group"), u.parentNode.removeChild(u)))
                                                                      : i !== u.textContent.replace(/\s/g, "") &&
                                                                        ([t, u].forEach(function (e) {
                                                                            e.setAttribute("data-cssvars-job", g.job), e.setAttribute("data-cssvars-group", o);
                                                                        }),
                                                                        (u.textContent = n),
                                                                        d.push(n),
                                                                        m.push(u),
                                                      ...
                                                      } else t.textContent.replace(/\s/g, "") !== n && d.push(n);
                                                  } catch (e) {
                                                      a(e.message, t);
                                                  }
                                              r && t.setAttribute("data-cssvars", "skip"), t.hasAttribute("data-cssvars-job") || t.setAttribute("data-cssvars-job", g.job);
                                          }),
                                          (C = s.rootElement.querySelectorAll('[data-cssvars]:not([data-cssvars="out"])').length),
                                          s.shadowDOM)
                                      )
                                          for (var h, y = [s.rootElement].concat(t(s.rootElement.querySelectorAll("*"))), b = 0; (h = y[b]); ++b)
                                              if (h.shadowRoot && h.shadowRoot.querySelector("style")) {
                                                  var x = e({}, s, { rootElement: h.shadowRoot });
                                                  j(x);
                                              }
                                      s.updateDOM && v && _(s.rootElement), (w = !1), s.onComplete(d.join(""), m, JSON.parse(JSON.stringify(E.job)), V() - s.__benchmark);
                                  }
                              },
                          }));
            else
                                  ...
                                  (function (t) {
                                      return Array.apply(null, t).some(function (t) {
                                          ...
                                          if (o || n) {
                                              ...
                                              o && (B(e.rootElement), (E.dom = {})), c && c.parentNode.removeChild(c);
                                          }
                                          return s;
                                      });
                                  })(r.removedNodes))),
    ...
    function T(e, t) {
        return (
            (e.replace(S.cssComments, "").match(S.cssUrls) || []).forEach(function (r) {
    ...
    function V() {
        return h && (window.performance || {}).now ? window.performance.now() : new Date().getTime();
    }
    function B(e) {
    ...
    return (
        (j.reset = function () {
            for (var e in ((g.job = 0), (g.group = 0), (w = !1), x && (x.disconnect(), (x = null)), (C = 0), (O = null), (A = !1), E)) E[e] = {};
        }),
        j
    );
});
cssVars({ rootElement: document, shadowDOM: !1, include: "link[rel=stylesheet],style", exclude: "", variables: {}, onlyLegacy: !0, preserveStatic: !0, preserveVars: !1, silent: !1, updateDOM: !0, updateURLs: !0, watch: !1 });

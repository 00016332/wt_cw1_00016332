    ...
    a && Object.deepExtend(i, a),
        ...
        (i.fn.particle = function (e, a, t) {
            ...
            i.particles.move.straight
                ? ((this.vx = s.x), (this.vy = s.y), i.particles.move.random && ((this.vx = this.vx * Math.random()), (this.vy = this.vy * Math.random())))
        ...
        (i.fn.particle.prototype.draw = function () {
            ...
            switch (((i.canvas.ctx.fillStyle = n), i.canvas.ctx.beginPath(), e.shape)) {
                ...
                case "triangle":
                    ...
                    break;
                case "polygon":
                    i.fn.vendors.drawShape(i.canvas.ctx, e.x - a / (i.particles.shape.polygon.nb_sides / 3.5), e.y - a / 0.76, (2.66 * a) / (i.particles.shape.polygon.nb_sides / 3), i.particles.shape.polygon.nb_sides, 1);
                    break;
                case "star":
        ...
        (i.fn.particlesUpdate = function () {
            for (var e = 0; e < i.particles.array.length; e++) {
                ...
                else n = { x_left: -a.radius, x_right: i.canvas.w + a.radius, y_top: -a.radius, y_bottom: i.canvas.h + a.radius };
                switch (
                    (a.x - a.radius > i.canvas.w ? ((a.x = n.x_left), (a.y = Math.random() * i.canvas.h)) : a.x + a.radius < 0 && ((a.x = n.x_right), (a.y = Math.random() * i.canvas.h)),
                    a.y - a.radius > i.canvas.h ? ((a.y = n.y_top), (a.x = Math.random() * i.canvas.w)) : a.y + a.radius < 0 && ((a.y = n.y_bottom), (a.x = Math.random() * i.canvas.w)),
